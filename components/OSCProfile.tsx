...
import { Users, Plus, ShieldCheck, AlertTriangle, RefreshCw, FileCheck, Clock, Calendar } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {oscs.map((osc) => (
          <div key={osc.id} className="bg-white rounded-[3.5rem] border border-gray-100 shadow-sm hover:shadow-2xl transition-all group p-10 relative overflow-hidden">
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-2 leading-tight">{osc.name}</h3>
            ...
            <div className="space-y-6 pt-6 border-t border-gray-50">
               <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-bold text-gray-700 flex items-center gap-2">
                    <Calendar size={14} className="text-teal-600" /> 12/2024
                  </span>
               </div>
               <div className="flex items-center justify-between">
